    ...
    */
    ...
    public function postLogin(Request $request)
    {
        $this->validate($request, [
            $this->loginUsername() => 'required_without:institution_id',
			'institution_id' => 'required_without:' . $this->loginUsername(),
			'password' => 'required',
        ]);
        ...
        $credentials = $request->only($this->loginUsername(), 'institution_id', 'password');
		
		if (empty($credentials['institution_id'])) {
			unset($credentials['institution_id']);
		}
		
		if (empty($credentials[$this->loginUsername()])) {
